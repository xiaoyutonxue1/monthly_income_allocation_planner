        ...
        <div className="flex justify-end mb-4">
          <Button
            ...
            onClick={() => {
              if (chartLayout === "top") {
                setChartLayout("side");
              } else if (chartLayout === "side") {
                setChartLayout("bottom");
              } else {
                setChartLayout("top");
              }
            }}
            className="text-xs flex items-center gap-1 bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 hover:shadow-md transition-all"
          >
            {chartLayout === "top" ? (
              <>
        ...
        {chartLayout === "top" ? (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card className="shadow-lg h-full rounded-2xl border border-green-100 dark:border-green-900 overflow-hidden hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-green-50 dark:from-gray-800 dark:to-gray-900 md:col-span-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => setChartLayout("top")}
                          className="text-xs rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
                        >
                  ...
                  <CardContent className="p-4">
                    {groupExpenses.length > 0 ? (
                      <div className="space-y-6">
                        {groupExpenses.map((group) => {
                          ...
                          return (
                            ...
                            >
                                  ...
                                  <div className="flex flex-col items-end">
                                    ...
                                    <div className="flex items-center gap-1">
                                      ...
                                      <span className="text-gray-500 text-xs">
                                        / 推荐: {group.recommendedPercentage}%
                                      </span>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="relative h-9 w-full bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden mt-2 mb-3">
                                {/* 推荐比例标记线 */}
                                <div
                                  className="absolute h-full w-px bg-gray-400 dark:bg-gray-300 z-10 flex items-center justify-center"
                                  style={{
                                    left: `${group.recommendedPercentage}%`,
                                    boxShadow: "0 0 4px rgba(0,0,0,0.2)",
                                  }}
                                >
                                  <div className="absolute -top-5 transform -translate-x-1/2 bg-gray-200 dark:bg-gray-600 text-xs font-medium px-1.5 py-0.5 rounded-sm text-gray-700 dark:text-gray-300 whitespace-nowrap">
                                    推荐 {group.recommendedPercentage}%
                                  </div>
                                </div>
                                ...
                                {/* 实际进度条 */}
                                <div
                                  className={`h-full rounded-full flex items-center justify-end px-3 text-xs text-white font-medium transition-all ease-out duration-700`}
                                  style={{
                                    width: `${Math.min(100, group.actualPercentage)}%`,
                                    backgroundColor: group.isExceeding
                                      ? "#ef4444"
                                      : group.color,
                                    boxShadow: group.isExceeding
                                      ? "0 0 8px rgba(239, 68, 68, 0.5)"
                                      : `0 0 8px ${group.color}50`,
                                    backgroundImage: `linear-gradient(90deg, ${group.color}80, ${group.color})`,
                                  }}
                                >
                                  {group.actualPercentage >= 5
                                    ? `${group.actualPercentage.toFixed(1)}%`
                                    : ""}
                                </div>
                                {group.actualPercentage < 5 && (
                                  <span className="absolute right-2 top-1/2 transform -translate-y-1/2 text-xs text-gray-600 dark:text-gray-300">
                                    {group.actualPercentage.toFixed(1)}%
                                  </span>
                                )}
                              </div>
                              ...
                              {groupAllocations.length > 0 && (
                                <div
                                  className="mt-3 pl-3 space-y-2 bg-white/50 dark:bg-gray-800/50 rounded-lg p-2"
                                  style={{
                                    borderLeft: `3px solid ${group.color}`,
                                  }}
                                >
                                  <div className="text-xs uppercase tracking-wider font-semibold text-gray-500 dark:text-gray-400 pb-1 mb-1 border-b border-gray-200 dark:border-gray-700">
                                    详细支出项目
                                  </div>
                                  {groupAllocations.map((alloc) => {
                                    ...
                                    return (
                                      <div
                                        key={alloc.id}
                                        className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-1.5 px-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-sm transition-colors"
                                      >
                                        ...
                                        <div className="flex items-center gap-3 ml-4 sm:ml-0">
                                          <div className="h-2 w-20 bg-gray-200 dark:bg-gray-600 rounded-full overflow-hidden">
                                            <div
                        ...
                        <div className="mt-6 p-5 bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-900 rounded-xl border border-blue-100 dark:border-blue-900 shadow-md">
                          <div className="flex flex-col space-y-4">
                            <div className="flex justify-between items-center text-sm border-b pb-3 border-gray-200 dark:border-gray-700">
                              <span className="font-medium text-gray-600 dark:text-gray-400 flex items-center">
                                <ArrowUpCircleIcon className="h-4 w-4 mr-1 text-blue-500" />
                                总收入
                              </span>
                            ...
                            <div className="flex justify-between items-center text-sm border-b pb-3 border-gray-200 dark:border-gray-700">
                              <span className="font-medium text-gray-600 dark:text-gray-400 flex items-center">
                                <ArrowDownCircleIcon className="h-4 w-4 mr-1 text-red-500" />
                                总支出
                              </span>
                            ...
                            <div className="flex justify-between items-center pt-2">
                              ...
                              <span
                                className={`font-bold text-xl ${(currentMonthData?.income || 0) - groupExpenses.reduce((sum, group) => sum + group.totalExpense, 0) >= 0 ? "text-green-500" : "text-red-500"}`}
                              >
                                ¥
                                {(
                                  (currentMonthData?.income || 0) -
                      ...
                      <EmptyPlaceholder>
                        <div className="flex flex-col items-center justify-center text-center p-8">
                          <LayoutDashboardIcon className="h-12 w-12 text-gray-300 mb-4" />
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-4 h-full">
                ...
                {/* 预算模板支出分析 */}
                {activeTemplate && groupExpenses.length > 0 && (
                  <Card className="shadow-lg rounded-2xl border border-blue-100 dark:border-blue-900 overflow-hidden hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-900 flex-grow">
                    <CardHeader className="border-b bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-4">
                      <CardTitle className="flex items-center gap-2 text-base">
                        <BarChart3Icon className="h-5 w-5 text-blue-500" />
                      ...
                      <div className="space-y-6">
                        {groupExpenses.map((group) => {
                          ...
                          return (
                            <div key={group.id} className="relative">
                              <div className="flex justify-between items-center mb-1">
                                ...
                                <div className="text-sm flex items-center gap-2">
                                  ...
                                  {group.isExceeding && (
                                    <Badge
                                      variant="destructive"
                                      className="text-xs px-1.5 py-0 h-5 bg-red-100 text-red-700 border border-red-200 dark:bg-red-900/30 dark:text-red-400 dark:border-red-800"
                                    >
                                      <AlertTriangleIcon className="h-3 w-3 mr-1" />
                                      超支
                                    </Badge>
                              ...
                              <div className="relative h-7 w-full bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                                {/* 推荐比例标记线 */}
                                <div
                                  className="absolute h-full w-px bg-gray-400 dark:bg-gray-300 z-10 flex items-center justify-center"
                                  style={{
                                ...
                                >
                                  <div className="absolute -top-4 transform -translate-x-1/2 bg-gray-200 dark:bg-gray-600 text-xs font-medium px-1 py-0.5 rounded-sm text-gray-700 dark:text-gray-300 whitespace-nowrap">
                                    推荐
                                  </div>
                                </div>

                                <div
                                  className={`h-full rounded-full flex items-center justify-end px-2 text-xs text-white font-medium transition-all ease-out duration-700`}
                                  style={{
                                    width: `${Math.min(100, group.actualPercentage)}%`,
                                    backgroundImage: `linear-gradient(90deg, ${group.color}80, ${group.color})`,
                                    backgroundColor: group.isExceeding
                              ...
                              <div
                                className="text-xs text-gray-500 mt-1 mb-2 bg-gray-50 dark:bg-gray-800/50 p-1.5 rounded-lg border-l-2"
                                style={{ borderColor: group.color }}
                              >
                                {group.description}
                              </div>
                              ...
                              {groupAllocations.length > 0 && (
                                <div
                                  className="mt-2 pl-3 space-y-1.5 bg-white/50 dark:bg-gray-800/50 rounded-lg p-2"
                                  style={{
                                    borderLeft: `3px solid ${group.color}`,
                                  }}
                                >
                                  ...
                                  {groupAllocations.map((alloc) => {
                                    ...
                                    return (
                                      <div
                                        key={alloc.id}
                                        className="flex justify-between items-center text-xs hover:bg-gray-100 dark:hover:bg-gray-700 p-1 rounded transition-colors"
                                      >
                                        <div className="flex items-center gap-1">
                                          <div
                                        ...
                                        <div className="flex items-center gap-2">
                                          <div className="h-1.5 w-12 bg-gray-200 dark:bg-gray-600 rounded-full overflow-hidden">
                                            <div
                                              className="h-full rounded-full"
                                              style={{
                                                width: `${Math.min(100, (percentage / group.actualPercentage) * 100)}%`,
                        ...
                        <div className="mt-6 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                          ...
                          <div className="flex justify-between text-sm font-medium pt-2 border-t border-gray-200 dark:border-gray-700 mt-2">
                            <span>结余</span>
                            <span
                              className={`${(currentMonthData?.income || 0) - groupExpenses.reduce((sum, group) => sum + group.totalExpense, 0) >= 0 ? "text-green-500" : "text-red-500"}`}
                            >
                              ¥
                              {(
                                (currentMonthData?.income || 0) -
